...
The OpenTracing specifications mentions a I<CARRIER FORMAT> and this was
initially used too. But the roles provided will autimagically detect the right
reference and a specific C<extract_from_*> or C<inject_into_*> method will
handle the exraction/injection at implementation level.
